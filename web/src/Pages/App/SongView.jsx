                ...
                <div className="rounded-lg bg-white overflow-hidden shadow justify-center mx-auto ">
                  <div className="p-6 pb-10">
                    <h1 className="text-xl font-bold">
                      {song.name} - {song.author.username}
                    </h1>
                    <p>{timeAgo.format(new Date(song.createdAt.toDate()))}</p>
                    <button
                      type="button"
                      className="inline-flex mt-2 items-center px-4 py-1 font-semibold leading-6 text-sm shadow rounded-md text-white bg-indigo-500 hover:bg-indigo-400 transition ease-in-out duration-150"
                      onClick={buy}
                      // onclick unfollow
                      disabled=""
                    >
